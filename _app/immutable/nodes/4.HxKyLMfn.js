import"../chunks/Bzak7iHL.js";import"../chunks/uVMgmwfs.js";import{f as t,b as e,d as q,s as c,r as N,ak as X,aE as J,a as w,$ as H}from"../chunks/dYMjUP6v.js";import{s as U,h as L}from"../chunks/9QyYluQo.js";import{i as R}from"../chunks/CQ34SgNU.js";var O=t('<h2 class="svelte-refgjh">A placeholder heading</h2>'),K=t('<p class="svelte-refgjh">Some placeholder content about why this thing is significant</p>'),Y=t('<div class="node svelte-refgjh"><div class="mb-8 inline-block rounded-md border border-slate-100 p-6 svelte-refgjh"><!> <!></div> <!></div>');function s(E,f){var M=Y(),P=q(M),F=q(P);{var _=u=>{var v=J(),A=w(v);U(A,()=>f.heading),e(u,v)},T=u=>{var v=O();e(u,v)};R(F,u=>{f.heading?u(_):u(T,!1)})}var z=c(F,2);{var W=u=>{var v=J(),A=w(v);U(A,()=>f.content),e(u,v)},j=u=>{var v=K();e(u,v)};R(z,u=>{f.content?u(W):u(j,!1)})}N(P);var B=c(P,2);U(B,()=>f.children??X),N(M),e(E,M)}var V=t('<h1 class="mt-0">My Career History</h1>'),Z=t(`<p>My intense curiosity has led me down a nonlinear career path. I'm
				...
				chronicled some of the highlights below in roughly chronological order.</p>`),Q=t('<h2 class="mt-0">Digipen, BSCS</h2>'),ee=t(`<div><p>At DigiPen I studied Computer Science and earned my Bachelor of
						...
						intertwined with sensitive business information protected by NDA.</p>`),Ge=t('<h4 class="mt-0">The right defaults</h4>'),De=t(`<div><p>Smaller studios were running into issues with configuring their
								...
								produced over 100K in profit for the studio.</p></div>`),je=t("<!> <!>",1),Be=t("<!> <!>",1),Ee=t('<h2 class="mt-0">Quantic MBA</h2>'),Fe=t(`<p>Having gone from a technical education to a role at the intersection of
					...
					understanding about business a year later.</p>`),Ue=t('<h2 class="mt-0">Ikigai Technologies</h2>'),qe=t(`<p>I wanted to try working at a smaller company, and Ikigai was a
					...
					a data infrastructure solution and two game products.</p>`),Ne=t('<h3 class="mt-0">Senior Software Engineer</h3>'),Je=t(`<div><p>Worked with React, NextJS, and MaterialUI in TypeScript to build out
						...
						early wins:</p> <ul><li>Doubled YoY attendance at the first meetup I organized</li> <li>Improved my leadership skills through coaching</li> <li>Currently organizing an event in collaboration with TC39</li></ul></div>`),Qe=t("<!> <!> <!> <!> <!> <!>",1),et=t('<div class="prose mx-auto"><!></div>');function it(E){var f=et();L(P=>{H.title="Career History - Allan Deutsch"});var M=q(f);s(M,{heading:_=>{var T=V();e(_,T)},content:_=>{var T=Z();e(_,T)},children:(_,T)=>{var z=Qe(),W=w(z);s(W,{heading:a=>{var n=Q();e(a,n)},content:a=>{var n=ee();e(a,n)},children:(a,n)=>{var y=ve(),b=w(y);s(b,{heading:o=>{var i=te();e(o,i)},content:o=>{var i=ae();e(o,i)},children:(o,i)=>{var x=se(),C=w(x);s(C,{heading:d=>{var $=oe();e(d,$)},content:d=>{var $=ne();e(d,$)},$$slots:{heading:!0,content:!0}});var p=c(C,2);s(p,{heading:d=>{var $=re();e(d,$)},content:d=>{var $=ie();e(d,$)},$$slots:{heading:!0,content:!0}}),e(o,x)},$$slots:{heading:!0,content:!0,default:!0}});var k=c(b,2);s(k,{heading:o=>{var i=de();e(o,i)},content:o=>{var i=he();e(o,i)},$$slots:{heading:!0,content:!0}});var S=c(k,2);s(S,{heading:o=>{var i=ce();e(o,i)},content:o=>{var i=le();e(o,i)},$$slots:{heading:!0,content:!0}});var I=c(S,2);s(I,{heading:o=>{var i=ue();e(o,i)},content:o=>{var i=ge();e(o,i)},$$slots:{heading:!0,content:!0}});var g=c(I,2);s(g,{heading:o=>{var i=pe();e(o,i)},content:o=>{var i=me();e(o,i)},$$slots:{heading:!0,content:!0}}),e(a,y)},$$slots:{heading:!0,content:!0,default:!0}});var j=c(W,2);s(j,{heading:a=>{var n=fe();e(a,n)},content:a=>{var n=we();e(a,n)},children:(a,n)=>{var y=Be(),b=w(y);s(b,{heading:g=>{var r=ye();e(g,r)},content:g=>{var r=be();e(g,r)},children:(g,r)=>{var h=Me(),o=w(h);s(o,{heading:l=>{var d=_e();e(l,d)},content:l=>{var d=ke();e(l,d)},$$slots:{heading:!0,content:!0}});var i=c(o,2);s(i,{heading:l=>{var d=Ie();e(l,d)},content:l=>{var d=xe();e(l,d)},$$slots:{heading:!0,content:!0}});var x=c(i,2);s(x,{heading:l=>{var d=$e();e(l,d)},content:l=>{var d=Te();e(l,d)},$$slots:{heading:!0,content:!0}});var C=c(x,2);s(C,{heading:l=>{var d=Se();e(l,d)},content:l=>{var d=Ce();e(l,d)},$$slots:{heading:!0,content:!0}}),e(g,h)},$$slots:{heading:!0,content:!0,default:!0}});var k=c(b,2);s(k,{heading:g=>{var r=Pe();e(g,r)},content:g=>{var r=Ae();e(g,r)},children:(g,r)=>{var h=je(),o=w(h);s(o,{heading:p=>{var m=Ge();e(p,m)},content:p=>{var m=De();e(p,m)},$$slots:{heading:!0,content:!0}});var i=c(o,2);s(i,{heading:p=>{var m=ze();e(p,m)},content:p=>{var m=We();e(p,m)},$$slots:{heading:!0,content:!0}}),e(g,h)},$$slots:{heading:!0,content:!0,default:!0}}),e(a,y)},$$slots:{heading:!0,content:!0,default:!0}});var B=c(j,2);s(B,{heading:a=>{var n=Ee();e(a,n)},content:a=>{var n=Fe();e(a,n)},$$slots:{heading:!0,content:!0}});var u=c(B,2);s(u,{heading:a=>{var n=Ue();e(a,n)},content:a=>{var n=qe();e(a,n)},children:(a,n)=>{var y=Oe(),b=w(y);s(b,{heading:r=>{var h=Ne();e(r,h)},content:r=>{var h=Je();e(r,h)},$$slots:{heading:!0,content:!0}});var k=c(b,2);s(k,{heading:r=>{var h=Re();e(r,h)},content:r=>{var h=Xe();e(r,h)},$$slots:{heading:!0,content:!0}});var S=c(k,2);s(S,{heading:r=>{var h=He();e(r,h)},content:r=>{var h=Le();e(r,h)},$$slots:{heading:!0,content:!0}}),e(a,y)},$$slots:{heading:!0,content:!0,default:!0}});var v=c(u,2);s(v,{heading:a=>{var n=Ke();e(a,n)},content:a=>{var n=Ye();e(a,n)},$$slots:{heading:!0,content:!0}});var A=c(v,2);s(A,{heading:a=>{var n=Ve();e(a,n)},content:a=>{var n=Ze();e(a,n)},$$slots:{heading:!0,content:!0}}),e(_,z)}}),N(f),e(E,f)}export{it as component};
