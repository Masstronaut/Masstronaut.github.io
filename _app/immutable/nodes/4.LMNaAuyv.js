import"../chunks/Bzak7iHL.js";import"../chunks/BjZVtCDr.js";import{f as t,b as e,d as q,s as c,r as N,am as X,al as J,a as w,$ as H}from"../chunks/BJtFNpt7.js";import{s as E,h as L}from"../chunks/Dkw9-BwW.js";import{i as R}from"../chunks/BZMo7the.js";var O=t('<h2 class="svelte-refgjh">A placeholder heading</h2>'),K=t('<p class="svelte-refgjh">Some placeholder content about why this thing is significant</p>'),Y=t('<div class="node svelte-refgjh"><div class="mb-8 inline-block rounded-md border border-slate-100 p-6 svelte-refgjh"><!> <!></div> <!></div>');function s(F,f){var M=Y(),P=q(M),U=q(P);{var _=u=>{var v=J(),A=w(v);E(A,()=>f.heading),e(u,v)},T=u=>{var v=O();e(u,v)};R(U,u=>{f.heading?u(_):u(T,!1)})}var z=c(U,2);{var W=u=>{var v=J(),A=w(v);E(A,()=>f.content),e(u,v)},j=u=>{var v=K();e(u,v)};R(z,u=>{f.content?u(W):u(j,!1)})}N(P);var B=c(P,2);E(B,()=>f.children??X),N(M),e(F,M)}var V=t('<h1 class="mt-0">My Career History</h1>'),Z=t(`<p>My intense curiosity has led me down a nonlinear career path. I'm
				...
				chronicled some of the highlights below in roughly chronological order.</p>`),Q=t('<h2 class="mt-0">Digipen, BSCS</h2>'),ee=t(`<div><p>At DigiPen I studied Computer Science and earned my Bachelor of
						...
						intertwined with sensitive business information protected by NDA.</p>`),Ge=t('<h4 class="mt-0">The right defaults</h4>'),De=t(`<div><p>Smaller studios were running into issues with configuring their
								...
								produced over 100K in profit for the studio.</p></div>`),je=t("<!> <!>",1),Be=t("<!> <!>",1),Fe=t('<h2 class="mt-0">Quantic MBA</h2>'),Ue=t(`<p>Having gone from a technical education to a role at the intersection of
