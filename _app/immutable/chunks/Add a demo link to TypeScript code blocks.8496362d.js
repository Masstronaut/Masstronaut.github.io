import{s as W,C as O,N as X,f as h,a as c,I as L,e as $,g as D,u as y,c as d,K as H,i as l,A as Y,d as t}from"./scheduler.e9e6880c.js";import{S as ss,i as as,b as ns,d as es,m as ls,a as ts,t as os,e as is}from"./index.ebf47752.js";import{g as ps,a as Z}from"./spread.8a54911c.js";import{M as rs}from"./MDSveXNoteLayout.cf6587ef.js";function ks(f){let a,k='TypeScript Playground is an online tool to interactive with TypeScript. It’s a great way to test out small snippets, share repros, and experiment with the language as it is portable and requires no setup. Recently, I learned about another amazing feature - it’s possible to <em>Dynamically generate TypeScript Playground links</em> for any TypeScript code! Technical writing should <a href="/notes/Make%20example%20code%20interactive/">Make example code interactive</a>, and this is an excellent way to do it.',p,i,e="Once I’ve got my TS playground link generated, all that’s left is to put the link on the page. Easy!",o,r,q="I already built a copy button for my  code blocks, which makes this even easier. I modified that code to render TS playground links instead of copy buttons. This Svelte component renders a link as a small square button:",S,A,K=`<pre class="shiki shiki-themes github-light slack-dark" style="background-color:#fff;--shiki-dark-bg:#222222;color:#24292e;--shiki-dark:#E6E6E6" tabindex="0" svelte filename="TSPlaygroundButton.svelte"><code><span class="line"><span style="color:#24292E;--shiki-dark:#808080">&#x3C;</span><span style="color:#22863A;--shiki-dark:#569CD6">script</span><span style="color:#6F42C1;--shiki-dark:#9CDCFE"> lang</span><span style="color:#24292E;--shiki-dark:#E6E6E6">=</span><span style="color:#032F62;--shiki-dark:#CE9178">"ts"</span><span style="color:#24292E;--shiki-dark:#808080">></span></span>
...
&lt;/a&gt;</pre>`,v,C,R="Great! But I still need to find the <code>&lt;pre&gt;</code> tags with a <code>data-tsplay</code> attribute and use my new component with them. I only need this to happen on pages based on markdown and rendered using MDSveX, so I put the logic in my mdsvex layout component.",I,E,z="For these links to show up on my code blocks, I need to:",M,u,j="<li>Find all the code block elements (<code>&lt;pre&gt;</code> tags) with a <code>data-tsplay</code> attribute</li> <li>Grab the TS playground link from the <code>data-tsplay</code> attribute</li> <li>Instantiate a <code>TSPlaygroundButton</code> with the link and put it on the code block</li>",P,m,G='1 &amp; 2 are pretty straightforward with basic browser APIs. I’m using svelte, so I did number 3 with the <a href="https://svelte.dev/docs/client-side-component-api#creating-a-component" rel="nofollow">Svelte client-side component API</a>. It should be pretty similar in other frameworks.',B,_,Q=`<pre class="shiki shiki-themes github-light slack-dark" style="background-color:#fff;--shiki-dark-bg:#222222;color:#24292e;--shiki-dark:#E6E6E6" tabindex="0" svelte filename="MDSVexLayout.svelte"><code><span class="line"><span style="color:#24292E;--shiki-dark:#808080">&#x3C;</span><span style="color:#22863A;--shiki-dark:#569CD6">script</span><span style="color:#24292E;--shiki-dark:#808080">></span></span>
