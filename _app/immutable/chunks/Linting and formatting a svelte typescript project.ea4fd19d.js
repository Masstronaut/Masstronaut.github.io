...
</pre>`,Cs,S,Be="My reasoning for these preferences:",se,z,Ue="<li>tabs are less characters than the equivalent spaces, and can be customized to render differently for people who prefer more spaces/indentation</li> <li>Single quotes add less visual noise than double quotes</li> <li>Less trailing commas means less syntax on screen, particularly syntax which does nothing</li> <li>Brackets on the same line means more code on screen and looks cleaner</li>",ee,$,Ye="The <code>overrides</code> is necessary for svelte files to be parsed correctly. It overrides the default parser with the <code>svelte</code> parser for files with the <code>.svelte</code> extension.",ae,b,Ge='<a aria-hidden="true" tabindex="-1" href="#prettier-ignore-file"><span class="icon icon-link"></span></a><a href="#prettier-ignore-file" aria-hidden="true" tabindex="-1"><span class="icon icon-link"></span></a>Prettier ignore file',ne,O,Je="I have a number of files which I <strong>don’t</strong> want to format. Those are defined in a <code>.prettierignore</code> file. My list denotes files that are generated programmatically or which are not maintained by me, such as the <code>node_modules</code>. Here’s the list:",te,ms,Ma=`<pre class="shiki shiki-themes github-light slack-dark" style="background-color:#fff;--shiki-dark-bg:#222222;color:#24292e;--shiki-dark:#E6E6E6" tabindex="0"><code><span class="line"><span>node_modules/**</span></span>
...
<span class="line"><span style="color:#24292E;--shiki-dark:#E6E6E6">	&#125;</span></span>
<span class="line"><span style="color:#24292E;--shiki-dark:#E6E6E6">&#125;</span></span></code></pre>`,ws,Fs,ja=`<pre class="code-copy-target hidden">&#123;
	"scripts" : &#123;
...
or <code>tests</code> folders. These can be customized per project.`,oe,V,Xe="<code>npm run lint</code> will run prettier to <em>check</em> all the matched files in the project and report if any have incorrect styling. I find this most helpful in CICD workflows where code won’t be changed; I want to fail the build early if it doesn’t match the style convention.",pe,W,sa="<code>npm run format</code> uses prettier to <em>format</em> all the project files. This will change them on disk. I use it as a final check after making changes or if my editor isn’t configured to format on edit or save.",re,B,ea="Speaking of configuring an editor to format on save…",ce,F,aa='<a aria-hidden="true" tabindex="-1" href="#configuring-zed-to-format-on-save-using-prettier"><span class="icon icon-link"></span></a><a href="#configuring-zed-to-format-on-save-using-prettier" aria-hidden="true" tabindex="-1"><span class="icon icon-link"></span></a>Configuring zed to format on save using prettier',de,U,na='If you install <a href="https://zed.dev/" rel="nofollow">zed</a> now, this will be configured by default. If you have had zed installed since before ~April 2024, you’ll want to make one small change to zed settings.',ke,Y,ta="from zed, you can do <code>cmd+shift+p</code> to open the command palette and select <code>zed: open settings</code>, or you can directly open the settings file at <code>~/.config/zed/settings.json</code>:",Ee,xs,qa=`<pre class="shiki shiki-themes github-light slack-dark" style="background-color:#fff;--shiki-dark-bg:#222222;color:#24292e;--shiki-dark:#E6E6E6" tabindex="0"><code><span class="line"><span style="color:#24292E;--shiki-dark:#E6E6E6">&#123;</span></span>
...
<span class="line"><span style="color:#6F42C1;--shiki-dark:#DCDCAA">npm</span><span style="color:#032F62;--shiki-dark:#CE9178"> i</span><span style="color:#005CC5;--shiki-dark:#CE9178"> --save-dev</span><span style="color:#032F62;--shiki-dark:#CE9178"> globals</span></span></code></pre>`,Ms,Ps,$a=`<pre class="code-copy-target hidden">npm i --save-dev eslint@8.56.0
...
<span class="line"><span style="color:#24292E;--shiki-dark:#E6E6E6">				&#123;</span></span>
<span class="line"><span style="color:#24292E;--shiki-dark:#9CDCFE">					argsIgnorePattern:</span><span style="color:#032F62;--shiki-dark:#CE9178"> '$$'</span><span style="color:#24292E;--shiki-dark:#E6E6E6">,</span></span>
<span class="line"><span style="color:#24292E;--shiki-dark:#9CDCFE">					varsIgnorePattern:</span><span style="color:#032F62;--shiki-dark:#CE9178"> '$$'</span><span style="color:#24292E;--shiki-dark:#E6E6E6">,</span></span>
<span class="line"><span style="color:#24292E;--shiki-dark:#9CDCFE">					caughtErrorsIgnorePattern:</span><span style="color:#032F62;--shiki-dark:#CE9178"> '$$'</span></span>
<span class="line"><span style="color:#24292E;--shiki-dark:#E6E6E6">				&#125;</span></span>
<span class="line"><span style="color:#24292E;--shiki-dark:#E6E6E6">			]</span></span>
<span class="line"><span style="color:#24292E;--shiki-dark:#E6E6E6">		&#125;</span></span>
<span class="line"><span style="color:#24292E;--shiki-dark:#E6E6E6">	&#125;,</span></span>
...
<span class="line"><span style="color:#24292E;--shiki-dark:#E6E6E6">);</span></span>
<span class="line"></span></code></pre>`,qs,Ss,Na=`<pre class="code-copy-target hidden">import js from '@eslint/js';
...
<span class="line"><span style="color:#24292E;--shiki-dark:#E6E6E6">	&#125;</span></span>
<span class="line"><span style="color:#24292E;--shiki-dark:#E6E6E6">&#125;</span></span></code></pre>`,Os,Ns,Va=`<pre class="code-copy-target hidden">&#123;
	"scripts": &#123;
		...
		// other scripts...
	&#125;
&#125;</pre>`,Rs,ps,ba="The <code>&quot;prelint&quot;</code> script, if provided, will always be run before the <code>&quot;lint&quot;</code> and <code>&quot;lint:fix&quot;</code> commands. It’s a super convenient way to ensure prettier runs before eslint. I also like that It reuses my existing <code>&quot;format&quot;</code> script rather than rewriting it in a second place. DRY code and all that.",Me,rs,wa="Now that everything is set up, crack open your CLI of choice and run <code>npm run lint</code> to get a bunch of automated feedback on your code. Happy hacking!";return{c(){r=l("p"),r.innerHTML=m,f=t(),y=l("p"),y.innerHTML=c,h=t(),u=l("p"),u.textContent=Ie,Vs=t(),A=l("ul"),A.innerHTML=je,Ws=t(),g=l("h2"),g.innerHTML=qe,Bs=t(),L=l("p"),L.textContent=Se,Us=t(),v=l("h3"),v.innerHTML=ze,Ys=t(),M=l("p"),M.innerHTML=$e,Gs=t(),ds=new d(!1),ks=k(),Es=new d(!1),hs=t(),P=l("p"),P.innerHTML=Oe,Js=t(),D=l("h3"),D.innerHTML=Ne,Ks=t(),I=l("p"),I.innerHTML=Re,Qs=t(),j=l("ol"),j.innerHTML=Ve,Zs=t(),q=l("p"),q.innerHTML=We,Xs=t(),ys=new d(!1),fs=k(),us=new d(!1),Cs=t(),S=l("p"),S.textContent=Be,se=t(),z=l("ul"),z.innerHTML=Ue,ee=t(),$=l("p"),$.innerHTML=Ye,ae=t(),b=l("h3"),b.innerHTML=Ge,ne=t(),O=l("p"),O.innerHTML=Je,te=t(),ms=new d(!1),gs=k(),vs=new d(!1),Ds=t(),w=l("h3"),w.innerHTML=Ke,ie=t(),N=l("p"),N.innerHTML=Qe,le=t(),bs=new d(!1),ws=k(),Fs=new d(!1),_s=t(),R=l("p"),R.innerHTML=Ze,oe=t(),V=l("p"),V.innerHTML=Xe,pe=t(),W=l("p"),W.innerHTML=sa,re=t(),B=l("p"),B.textContent=ea,ce=t(),F=l("h3"),F.innerHTML=aa,de=t(),U=l("p"),U.innerHTML=na,ke=t(),Y=l("p"),Y.innerHTML=ta,Ee=t(),xs=new d(!1),Ts=k(),Hs=new d(!1),As=t(),G=l("p"),G.innerHTML=ia,he=t(),_=l("h2"),_.innerHTML=la,ye=t(),J=l("p"),J.innerHTML=oa,fe=t(),K=l("p"),K.textContent=pa,ue=t(),x=l("h3"),x.innerHTML=ra,Ce=t(),Q=l("p"),Q.innerHTML=ca,me=t(),Ls=new d(!1),Ms=k(),Ps=new d(!1),Is=t(),T=l("h3"),T.innerHTML=da,ge=t(),Z=l("p"),Z.textContent=ka,ve=t(),X=l("ol"),X.innerHTML=Ea,De=t(),ss=l("p"),ss.innerHTML=ha,be=t(),js=new d(!1),qs=k(),Ss=new d(!1),zs=t(),es=l("p"),es.innerHTML=ya,we=t(),as=l("p"),as.innerHTML=fa,Fe=t(),ns=l("p"),ns.innerHTML=ua,_e=t(),ts=l("p"),ts.textContent=Ca,xe=t(),is=l("p"),is.innerHTML=ma,Te=t(),H=l("h3"),H.innerHTML=ga,He=t(),ls=l("p"),ls.textContent=va,Ae=t(),os=l("p"),os.innerHTML=Da,Le=t(),$s=new d(!1),Os=k(),Ns=new d(!1),Rs=t(),ps=l("p"),ps.innerHTML=ba,Me=t(),rs=l("p"),rs.innerHTML=wa,this.h()},l(s){r=o(s,"P",{["data-svelte-h"]:!0}),p(r)!=="svelte-1shthb7"&&(r.innerHTML=m),f=i(s),y=o(s,"P",{["data-svelte-h"]:!0}),p(y)!=="svelte-10sfsyg"&&(y.innerHTML=c),h=i(s),u=o(s,"P",{["data-svelte-h"]:!0}),p(u)!=="svelte-103q6e1"&&(u.textContent=Ie),Vs=i(s),A=o(s,"UL",{["data-svelte-h"]:!0}),p(A)!=="svelte-oprkpr"&&(A.innerHTML=je),Ws=i(s),g=o(s,"H2",{id:!0,["data-svelte-h"]:!0}),p(g)!=="svelte-4xfkqc"&&(g.innerHTML=qe),Bs=i(s),L=o(s,"P",{["data-svelte-h"]:!0}),p(L)!=="svelte-1wdaf5d"&&(L.textContent=Se),Us=i(s),v=o(s,"H3",{id:!0,["data-svelte-h"]:!0}),p(v)!=="svelte-1dpq7w0"&&(v.innerHTML=ze),Ys=i(s),M=o(s,"P",{["data-svelte-h"]:!0}),p(M)!=="svelte-mjoeia"&&(M.innerHTML=$e),Gs=i(s),ds=E(s,!1),ks=k(),Es=E(s,!1),hs=i(s),P=o(s,"P",{["data-svelte-h"]:!0}),p(P)!=="svelte-19x8frn"&&(P.innerHTML=Oe),Js=i(s),D=o(s,"H3",{id:!0,["data-svelte-h"]:!0}),p(D)!=="svelte-1gwxumn"&&(D.innerHTML=Ne),Ks=i(s),I=o(s,"P",{["data-svelte-h"]:!0}),p(I)!=="svelte-aovl55"&&(I.innerHTML=Re),Qs=i(s),j=o(s,"OL",{["data-svelte-h"]:!0}),p(j)!=="svelte-volqe7"&&(j.innerHTML=Ve),Zs=i(s),q=o(s,"P",{["data-svelte-h"]:!0}),p(q)!=="svelte-2v77kd"&&(q.innerHTML=We),Xs=i(s),ys=E(s,!1),fs=k(),us=E(s,!1),Cs=i(s),S=o(s,"P",{["data-svelte-h"]:!0}),p(S)!=="svelte-w9a446"&&(S.textContent=Be),se=i(s),z=o(s,"UL",{["data-svelte-h"]:!0}),p(z)!=="svelte-1s995mp"&&(z.innerHTML=Ue),ee=i(s),$=o(s,"P",{["data-svelte-h"]:!0}),p($)!=="svelte-1wrrzwo"&&($.innerHTML=Ye),ae=i(s),b=o(s,"H3",{id:!0,["data-svelte-h"]:!0}),p(b)!=="svelte-1gv59yo"&&(b.innerHTML=Ge),ne=i(s),O=o(s,"P",{["data-svelte-h"]:!0}),p(O)!=="svelte-110zqo9"&&(O.innerHTML=Je),te=i(s),ms=E(s,!1),gs=k(),vs=E(s,!1),Ds=i(s),w=o(s,"H3",{id:!0,["data-svelte-h"]:!0}),p(w)!=="svelte-18knu64"&&(w.innerHTML=Ke),ie=i(s),N=o(s,"P",{["data-svelte-h"]:!0}),p(N)!=="svelte-1yogda2"&&(N.innerHTML=Qe),le=i(s),bs=E(s,!1),ws=k(),Fs=E(s,!1),_s=i(s),R=o(s,"P",{["data-svelte-h"]:!0}),p(R)!=="svelte-13eid77"&&(R.innerHTML=Ze),oe=i(s),V=o(s,"P",{["data-svelte-h"]:!0}),p(V)!=="svelte-bj6mdb"&&(V.innerHTML=Xe),pe=i(s),W=o(s,"P",{["data-svelte-h"]:!0}),p(W)!=="svelte-1os89jn"&&(W.innerHTML=sa),re=i(s),B=o(s,"P",{["data-svelte-h"]:!0}),p(B)!=="svelte-1p5zcp8"&&(B.textContent=ea),ce=i(s),F=o(s,"H3",{id:!0,["data-svelte-h"]:!0}),p(F)!=="svelte-n7ws53"&&(F.innerHTML=aa),de=i(s),U=o(s,"P",{["data-svelte-h"]:!0}),p(U)!=="svelte-j7r4fg"&&(U.innerHTML=na),ke=i(s),Y=o(s,"P",{["data-svelte-h"]:!0}),p(Y)!=="svelte-12ek43x"&&(Y.innerHTML=ta),Ee=i(s),xs=E(s,!1),Ts=k(),Hs=E(s,!1),As=i(s),G=o(s,"P",{["data-svelte-h"]:!0}),p(G)!=="svelte-qxxwsp"&&(G.innerHTML=ia),he=i(s),_=o(s,"H2",{id:!0,["data-svelte-h"]:!0}),p(_)!=="svelte-1yp82k2"&&(_.innerHTML=la),ye=i(s),J=o(s,"P",{["data-svelte-h"]:!0}),p(J)!=="svelte-13jc2pd"&&(J.innerHTML=oa),fe=i(s),K=o(s,"P",{["data-svelte-h"]:!0}),p(K)!=="svelte-1dqgyon"&&(K.textContent=pa),ue=i(s),x=o(s,"H3",{id:!0,["data-svelte-h"]:!0}),p(x)!=="svelte-1rxrh2j"&&(x.innerHTML=ra),Ce=i(s),Q=o(s,"P",{["data-svelte-h"]:!0}),p(Q)!=="svelte-1jy7x7i"&&(Q.innerHTML=ca),me=i(s),Ls=E(s,!1),Ms=k(),Ps=E(s,!1),Is=i(s),T=o(s,"H3",{id:!0,["data-svelte-h"]:!0}),p(T)!=="svelte-1uday53"&&(T.innerHTML=da),ge=i(s),Z=o(s,"P",{["data-svelte-h"]:!0}),p(Z)!=="svelte-1d3xafx"&&(Z.textContent=ka),ve=i(s),X=o(s,"OL",{["data-svelte-h"]:!0}),p(X)!=="svelte-18dbg18"&&(X.innerHTML=Ea),De=i(s),ss=o(s,"P",{["data-svelte-h"]:!0}),p(ss)!=="svelte-uraean"&&(ss.innerHTML=ha),be=i(s),js=E(s,!1),qs=k(),Ss=E(s,!1),zs=i(s),es=o(s,"P",{["data-svelte-h"]:!0}),p(es)!=="svelte-ka0m9m"&&(es.innerHTML=ya),we=i(s),as=o(s,"P",{["data-svelte-h"]:!0}),p(as)!=="svelte-1d643sl"&&(as.innerHTML=fa),Fe=i(s),ns=o(s,"P",{["data-svelte-h"]:!0}),p(ns)!=="svelte-1q8phol"&&(ns.innerHTML=ua),_e=i(s),ts=o(s,"P",{["data-svelte-h"]:!0}),p(ts)!=="svelte-c26n3y"&&(ts.textContent=Ca),xe=i(s),is=o(s,"P",{["data-svelte-h"]:!0}),p(is)!=="svelte-1l2j2ko"&&(is.innerHTML=ma),Te=i(s),H=o(s,"H3",{id:!0,["data-svelte-h"]:!0}),p(H)!=="svelte-fockc6"&&(H.innerHTML=ga),He=i(s),ls=o(s,"P",{["data-svelte-h"]:!0}),p(ls)!=="svelte-1hso8ru"&&(ls.textContent=va),Ae=i(s),os=o(s,"P",{["data-svelte-h"]:!0}),p(os)!=="svelte-tt1l48"&&(os.innerHTML=Da),Le=i(s),$s=E(s,!1),Os=k(),Ns=E(s,!1),Rs=i(s),ps=o(s,"P",{["data-svelte-h"]:!0}),p(ps)!=="svelte-iif4k4"&&(ps.innerHTML=ba),Me=i(s),rs=o(s,"P",{["data-svelte-h"]:!0}),p(rs)!=="svelte-1bw5zzv"&&(rs.innerHTML=wa),this.h()},h(){C(g,"id","setting-up-prettier"),C(v,"id","installing-prettier-packages"),ds.a=ks,Es.a=hs,C(D,"id","configuring-prettier"),ys.a=fs,us.a=Cs,C(b,"id","prettier-ignore-file"),ms.a=gs,vs.a=Ds,C(w,"id","running-prettier-via-npm-scripts"),bs.a=ws,Fs.a=_s,C(F,"id","configuring-zed-to-format-on-save-using-prettier"),xs.a=Ts,Hs.a=As,C(_,"id","static-code-analysis-for-svelte--typescript-using-eslint"),C(x,"id","installing-eslint-and-plugins"),Ls.a=Ms,Ps.a=Is,C(T,"id","configuring-eslint"),js.a=qs,Ss.a=zs,C(H,"id","adding-a-lint-command-to-packagejson"),$s.a=Os,Ns.a=Rs},m(s,e){a(s,r,e),a(s,f,e),a(s,y,e),a(s,h,e),a(s,u,e),a(s,Vs,e),a(s,A,e),a(s,Ws,e),a(s,g,e),a(s,Bs,e),a(s,L,e),a(s,Us,e),a(s,v,e),a(s,Ys,e),a(s,M,e),a(s,Gs,e),ds.m(Ta,s,e),a(s,ks,e),Es.m(Ha,s,e),a(s,hs,e),a(s,P,e),a(s,Js,e),a(s,D,e),a(s,Ks,e),a(s,I,e),a(s,Qs,e),a(s,j,e),a(s,Zs,e),a(s,q,e),a(s,Xs,e),ys.m(Aa,s,e),a(s,fs,e),us.m(La,s,e),a(s,Cs,e),a(s,S,e),a(s,se,e),a(s,z,e),a(s,ee,e),a(s,$,e),a(s,ae,e),a(s,b,e),a(s,ne,e),a(s,O,e),a(s,te,e),ms.m(Ma,s,e),a(s,gs,e),vs.m(Pa,s,e),a(s,Ds,e),a(s,w,e),a(s,ie,e),a(s,N,e),a(s,le,e),bs.m(Ia,s,e),a(s,ws,e),Fs.m(ja,s,e),a(s,_s,e),a(s,R,e),a(s,oe,e),a(s,V,e),a(s,pe,e),a(s,W,e),a(s,re,e),a(s,B,e),a(s,ce,e),a(s,F,e),a(s,de,e),a(s,U,e),a(s,ke,e),a(s,Y,e),a(s,Ee,e),xs.m(qa,s,e),a(s,Ts,e),Hs.m(Sa,s,e),a(s,As,e),a(s,G,e),a(s,he,e),a(s,_,e),a(s,ye,e),a(s,J,e),a(s,fe,e),a(s,K,e),a(s,ue,e),a(s,x,e),a(s,Ce,e),a(s,Q,e),a(s,me,e),Ls.m(za,s,e),a(s,Ms,e),Ps.m($a,s,e),a(s,Is,e),a(s,T,e),a(s,ge,e),a(s,Z,e),a(s,ve,e),a(s,X,e),a(s,De,e),a(s,ss,e),a(s,be,e),js.m(Oa,s,e),a(s,qs,e),Ss.m(Na,s,e),a(s,zs,e),a(s,es,e),a(s,we,e),a(s,as,e),a(s,Fe,e),a(s,ns,e),a(s,_e,e),a(s,ts,e),a(s,xe,e),a(s,is,e),a(s,Te,e),a(s,H,e),a(s,He,e),a(s,ls,e),a(s,Ae,e),a(s,os,e),a(s,Le,e),$s.m(Ra,s,e),a(s,Os,e),Ns.m(Va,s,e),a(s,Rs,e),a(s,ps,e),a(s,Me,e),a(s,rs,e)},p:Ba,d(s){s&&(n(r),n(f),n(y),n(h),n(u),n(Vs),n(A),n(Ws),n(g),n(Bs),n(L),n(Us),n(v),n(Ys),n(M),n(Gs),n(ks),ds.d(),Es.d(),n(hs),n(P),n(Js),n(D),n(Ks),n(I),n(Qs),n(j),n(Zs),n(q),n(Xs),n(fs),ys.d(),us.d(),n(Cs),n(S),n(se),n(z),n(ee),n($),n(ae),n(b),n(ne),n(O),n(te),n(gs),ms.d(),vs.d(),n(Ds),n(w),n(ie),n(N),n(le),n(ws),bs.d(),Fs.d(),n(_s),n(R),n(oe),n(V),n(pe),n(W),n(re),n(B),n(ce),n(F),n(de),n(U),n(ke),n(Y),n(Ee),n(Ts),xs.d(),Hs.d(),n(As),n(G),n(he),n(_),n(ye),n(J),n(fe),n(K),n(ue),n(x),n(Ce),n(Q),n(me),n(Ms),Ls.d(),Ps.d(),n(Is),n(T),n(ge),n(Z),n(ve),n(X),n(De),n(ss),n(be),n(qs),js.d(),Ss.d(),n(zs),n(es),n(we),n(as),n(Fe),n(ns),n(_e),n(ts),n(xe),n(is),n(Te),n(H),n(He),n(ls),n(Ae),n(os),n(Le),n(Os),$s.d(),Ns.d(),n(Rs),n(ps),n(Me),n(rs))}}}function nn(cs){let r,m;const f=[cs[0],xa];let y={$$slots:{default:[an]},$$scope:{ctx:cs}};for(let c=0;c<f.length;c+=1)y=Pe(y,f[c]);return r=new en({props:y}),{c(){Ga(r.$$.fragment)},l(c){Ja(r.$$.fragment,c)},m(c,h){Ka(r,c,h),m=!0},p(c,[h]){const u=h&1?sn(f,[h&1&&_a(c[0]),h&0&&_a(xa)]):{};h&2&&(u.$$scope={dirty:h,ctx:c}),r.$set(u)},i(c){m||(Qa(r.$$.fragment,c),m=!0)},o(c){Za(r.$$.fragment,c),m=!1},d(c){Xa(r,c)}}}const xa={title:"Linting and formatting a svelte project",description:"Pulling together a bunch of language tools can be a bother, but I find automated formatting & code review tools are worth the hassle.",slug:"lint-format-svelte",publish:!0,lastmod:"2024-04-15T00:00:00.000Z",date:"2024-04-13T00:00:00.000Z",aliases:null,tags:["status/budding","topic/webdev"],timeToRead:9,internalLinks:[],flashcards:[]};function tn(cs,r,m){return cs.$$set=f=>{m(0,r=Pe(Pe({},r),Fa(f)))},r=Fa(r),[r]}class cn extends Ua{constructor(r){super(),Ya(this,r,tn,nn,Wa,{})}}export{cn as default,xa as metadata};
